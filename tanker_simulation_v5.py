...
class Simulation:
    ...
    def _sj_transload_trigger_check(self, t):
        ...
        # floor (MIN_INCOMING_TRANSFER_BBL — one daughter cargo) so SanJulian
        # does not sit holding volume when all mothers are near-full.
        # Only fires when SanJulian herself holds at least SANJULIAN_OPTIM_MIN_SPACE_BBL.
