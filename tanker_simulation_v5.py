...
class Simulation:
    ...
    def _maybe_run_multiple_transient_op(self, t):
        ...
        # ── Gate 3: confirm that NO mother/SanJulian can currently receive ────
        _primary_mothers = [
            mn for mn in MOTHER_NAMES
            if mn != MOTHER_QUATERNARY_NAME    # check primaries and SanJulian
        ]
        ...
        if receiver_available:
            return   # a mother has room — normal operations should handle this
