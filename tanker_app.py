...
def run_sim(sim_days, chapel, jasmines, westmore, duke, starturn,
    ...
    if vessel_states_json:
        ...
        for v in sim.vessels:
            if v.name in vs:
                d = vs[v.name]
                # Reset sticky startup assignments (e.g., Woodstock@Duke seed)
                # so manual Day-1 positioning fully controls initial placement.
    ...
    for _v in sim.vessels:
        ...
        # emitted the same t=0 LOADING_START (e.g., Woodstock seeded at Duke).
