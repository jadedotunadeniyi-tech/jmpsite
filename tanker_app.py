            ...
            if _stock_pdf is not None:
                ...
                if st.session_state.get("_pdf_last_hash") != _pdf_hash:
                    ...
                    try:
                        ...
                        # Gemini 1.5 Flash — free tier, excellent PDF reading
                        _gemini_url = (
                            "https://generativelanguage.googleapis.com/v1beta/models/"
                            f"gemini-1.5-flash-latest:generateContent?key={_pdf_api_key}"
                        )
                        ...
                        if _resp.status_code != 200:
                            ...
                            try:
                                ...
                                pass
                            _http_msg = (
                                _http_body.get("error", {}).get("message", _resp.text[:300])
                            )
