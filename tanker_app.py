...
def run_sim(sim_days, chapel, jasmines, westmore, duke, starturn,
    ...
    if vessel_states_json:
        ...
        for v in sim.vessels:
            if v.name in vs:
                d = vs[v.name]
                # Reset sticky startup assignments
    ...
    _POINT_B_START_VESSELS = {"Sherlock", "Laphroaig", "Rathbone", "Woodstock"}
    ...
    # This covers both manual overrides (vessel_states_json) and any
    # vessels seeded in LOADING status by their startup defaults.
