...
=============================================================
  ...
  Tab 1  "volumes"   — one row per daily 8am update
    Columns: timestamp | chapel_bbl | jasmines_bbl | westmore_bbl |
             ...
             greeneagle_bbl | mtsanbarth_bbl | production_bph | sim_days
...
LOCATION_CATALOGUE = [
    ...
    {"display": "Sailing → MT SanBarth (A/C outbound)", "sim_value": "En Route SanBarth→BIA",
     "field_zone": "Transit", "target_mother": "MTSanBarth", "target_storage": None,
     "statuses": [
        ("SAILING_AB",          "🚢 Leg 1: Point A/C → Breakwater (1.5h)"),
        ("SAILING_CROSS_BW_AC", "🚢 Leg 2: Crossing Breakwater outbound (0.5h)"),
        ("SAILING_BW_TO_FWY",   "🚢 Leg 3: Breakwater → Fairway Buoy (2h)"),
    ...
    {"display": "Approaching MT SanBarth (Fairway Buoy)", "sim_value": "Fairway Buoy",
     "field_zone": "Transit", "target_mother": "MTSanBarth", "target_storage": None,
     "statuses": [
        ("SAILING_BW_TO_FWY",   "🚢 Breakwater → Fairway Buoy (2h)"),
        ("SAILING_AB_LEG2",     "🚢 Fairway Buoy → BIA (2h)"),
    ...
    {"display": "Breakwater outbound → MT SanBarth", "sim_value": "Breakwater (outbound)",
     "field_zone": "Transit", "target_mother": "MTSanBarth", "target_storage": None,
     "statuses": [
        ("SAILING_CH_TO_BW_OUT", "🚢 Channel → Breakwater (1h, tidal)"),
        ("SAILING_CROSS_BW_OUT", "🚢 Crossing Breakwater outbound (0.5h, tidal)"),
    ...
    {"display": "Cawthorne Channel outbound → MT SanBarth", "sim_value": "Cawthorne Channel (outbound)",
     "field_zone": "Transit", "target_mother": "MTSanBarth", "target_storage": None,
     "statuses": [
        ("SAILING_D_CHANNEL",    "🚢 Point D → Cawthorne Channel (3h, tidal)"),
        ("SAILING_CH_TO_BW_OUT", "🚢 Channel → Breakwater (1h, tidal)"),
    ...
    # ── MTO (Mid-Transfer Operation) at BIA — dynamic receiver vessel ────────
    # ══════════════════════════════════════════════════════════════════════════
    # ── MTO PAIRED ENTRIES  ───────────────────────────────────────────────────
    # Each entry locks a specific receiver ↔ discharger pair.
    # "Lock and Load" = receiver perspective (Bagshot locks on Rathbone to load from).
    # "Lock and Offload" = discharger perspective (Rathbone locks on Bagshot to pump into).
    # The sim will hard-pin the discharger to the receiver and vice-versa,
    # preventing the auto-engine from nominating a different transient.
    # ══════════════════════════════════════════════════════════════════════════
    {"display": "Lock and Load — Watson ← Sherlock",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Sherlock",
     "statuses": [
        ("WAITING_BERTH_B", "🔒 Locked receiver — awaiting Sherlock to berth and transfer"),
        ("PF_SWAP",         "📦 Loading from Sherlock — transfer in progress"),
        ("IDLE_B",          "⚓ Loaded — awaiting berth at mother vessel"),
    ]},
    {"display": "Lock and Offload — Sherlock → Watson",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Watson",
     "locked_receiver": "Watson",
     "statuses": [
        ("SAILING_AB_LEG2",  "🚢 Inbound — will offload to Watson on arrival"),
        ("WAITING_BERTH_B",  "⏳ Arrived — waiting to berth alongside Watson"),
        ("BERTHING_B",       "🔗 Berthing alongside Watson"),
        ("HOSE_CONNECT_B",   "🔧 Hose connected to Watson — pumping starting"),
        ("DISCHARGING",      "⬇️ Offloading to Watson — in progress"),
        ("CAST_OFF_B",       "↩️ Offload complete — casting off from Watson"),
    ]},
    {"display": "Lock and Load — Watson ← Laphroaig",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Laphroaig",
     "statuses": [
        ("WAITING_BERTH_B", "🔒 Locked receiver — awaiting Laphroaig to berth and transfer"),
        ("PF_SWAP",         "📦 Loading from Laphroaig — transfer in progress"),
        ("IDLE_B",          "⚓ Loaded — awaiting berth at mother vessel"),
    ]},
    {"display": "Lock and Offload — Laphroaig → Watson",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Watson",
    ...
    {"display": "Lock and Load — Watson ← Rathbone",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rathbone",
     "statuses": [
        ("WAITING_BERTH_B", "🔒 Locked receiver — awaiting Rathbone to berth and transfer"),
        ("PF_SWAP",         "📦 Loading from Rathbone — transfer in progress"),
        ("IDLE_B",          "⚓ Loaded — awaiting berth at mother vessel"),
    ]},
    {"display": "Lock and Offload — Rathbone → Watson",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Watson",
    ...
    {"display": "Lock and Load — Watson ← Balham",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Balham",
     "statuses": [
        ("WAITING_BERTH_B", "🔒 Locked receiver — awaiting Balham to berth and transfer"),
        ("PF_SWAP",         "📦 Loading from Balham — transfer in progress"),
        ("IDLE_B",          "⚓ Loaded — awaiting berth at mother vessel"),
    ]},
    {"display": "Lock and Offload — Balham → Watson",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Watson",
    ...
    {"display": "Lock and Load — Watson ← Bedford",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bedford",
     "statuses": [
        ("WAITING_BERTH_B", "🔒 Locked receiver — awaiting Bedford to berth and transfer"),
        ("PF_SWAP",         "📦 Loading from Bedford — transfer in progress"),
        ("IDLE_B",          "⚓ Loaded — awaiting berth at mother vessel"),
    ]},
    {"display": "Lock and Offload — Bedford → Watson",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Watson",
    ...
    {"display": "Lock and Load — Watson ← Woodstock",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Woodstock",
     "statuses": [
        ("WAITING_BERTH_B", "🔒 Locked receiver — awaiting Woodstock to berth and transfer"),
        ("PF_SWAP",         "📦 Loading from Woodstock — transfer in progress"),
        ("IDLE_B",          "⚓ Loaded — awaiting berth at mother vessel"),
    ]},
    {"display": "Lock and Offload — Woodstock → Watson",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Watson",
    ...
    {"display": "Lock and Load — Watson ← Bagshot",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bagshot",
     "statuses": [
        ("WAITING_BERTH_B", "🔒 Locked receiver — awaiting Bagshot to berth and transfer"),
        ("PF_SWAP",         "📦 Loading from Bagshot — transfer in progress"),
        ("IDLE_B",          "⚓ Loaded — awaiting berth at mother vessel"),
    ]},
    {"display": "Lock and Offload — Bagshot → Watson",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Watson",
    ...
    {"display": "Lock and Load — Watson ← Amyla",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Amyla",
     "statuses": [
        ("WAITING_BERTH_B", "🔒 Locked receiver — awaiting Amyla to berth and transfer"),
        ("PF_SWAP",         "📦 Loading from Amyla — transfer in progress"),
        ("IDLE_B",          "⚓ Loaded — awaiting berth at mother vessel"),
    ]},
    {"display": "Lock and Offload — Amyla → Watson",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Watson",
    ...
    {"display": "Lock and Load — Watson ← SantaMonica",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "SantaMonica",
     "statuses": [
        ("WAITING_BERTH_B", "🔒 Locked receiver — awaiting SantaMonica to berth and transfer"),
        ("PF_SWAP",         "📦 Loading from SantaMonica — transfer in progress"),
        ("IDLE_B",          "⚓ Loaded — awaiting berth at mother vessel"),
    ]},
    {"display": "Lock and Offload — SantaMonica → Watson",
     "sim_value": "SantaMonica",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Watson",
     "locked_receiver": "Watson",
    ...
    {"display": "Lock and Load — Watson ← Rahama",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rahama",
     "statuses": [
        ("WAITING_BERTH_B", "🔒 Locked receiver — awaiting Rahama to berth and transfer"),
        ("PF_SWAP",         "📦 Loading from Rahama — transfer in progress"),
        ("IDLE_B",          "⚓ Loaded — awaiting berth at mother vessel"),
    ]},
    {"display": "Lock and Offload — Rahama → Watson",
     "sim_value": "Rahama",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Watson",
    ...
    {"display": "Lock and Load — Sherlock ← Watson",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Watson",
     "statuses": [
        ("WAITING_BERTH_B", "🔒 Locked receiver — awaiting Watson to berth and transfer"),
        ("PF_SWAP",         "📦 Loading from Watson — transfer in progress"),
        ("IDLE_B",          "⚓ Loaded — awaiting berth at mother vessel"),
    ]},
    {"display": "Lock and Offload — Watson → Sherlock",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Sherlock",
     "locked_receiver": "Sherlock",
     "statuses": [
        ("SAILING_AB_LEG2",  "🚢 Inbound — will offload to Sherlock on arrival"),
        ("WAITING_BERTH_B",  "⏳ Arrived — waiting to berth alongside Sherlock"),
        ("BERTHING_B",       "🔗 Berthing alongside Sherlock"),
        ("HOSE_CONNECT_B",   "🔧 Hose connected to Sherlock — pumping starting"),
        ("DISCHARGING",      "⬇️ Offloading to Sherlock — in progress"),
        ("CAST_OFF_B",       "↩️ Offload complete — casting off from Sherlock"),
    ]},
    {"display": "Lock and Load — Sherlock ← Laphroaig",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Laphroaig",
    ...
    {"display": "Lock and Offload — Laphroaig → Sherlock",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Sherlock",
    ...
    {"display": "Lock and Load — Sherlock ← Rathbone",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rathbone",
    ...
    {"display": "Lock and Offload — Rathbone → Sherlock",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Sherlock",
    ...
    {"display": "Lock and Load — Sherlock ← Balham",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Balham",
    ...
    {"display": "Lock and Offload — Balham → Sherlock",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Sherlock",
    ...
    {"display": "Lock and Load — Sherlock ← Bedford",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bedford",
    ...
    {"display": "Lock and Offload — Bedford → Sherlock",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Sherlock",
    ...
    {"display": "Lock and Load — Sherlock ← Woodstock",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Woodstock",
    ...
    {"display": "Lock and Offload — Woodstock → Sherlock",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Sherlock",
    ...
    {"display": "Lock and Load — Sherlock ← Bagshot",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bagshot",
    ...
    {"display": "Lock and Offload — Bagshot → Sherlock",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Sherlock",
    ...
    {"display": "Lock and Load — Sherlock ← Amyla",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Amyla",
    ...
    {"display": "Lock and Offload — Amyla → Sherlock",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Sherlock",
    ...
    {"display": "Lock and Load — Sherlock ← SantaMonica",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "SantaMonica",
    ...
    {"display": "Lock and Offload — SantaMonica → Sherlock",
     "sim_value": "SantaMonica",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Sherlock",
    ...
    {"display": "Lock and Load — Sherlock ← Rahama",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rahama",
    ...
    {"display": "Lock and Offload — Rahama → Sherlock",
     "sim_value": "Rahama",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Sherlock",
    ...
    {"display": "Lock and Load — Laphroaig ← Watson",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Watson",
    ...
    {"display": "Lock and Offload — Watson → Laphroaig",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Laphroaig",
     "locked_receiver": "Laphroaig",
     "statuses": [
        ("SAILING_AB_LEG2",  "🚢 Inbound — will offload to Laphroaig on arrival"),
        ("WAITING_BERTH_B",  "⏳ Arrived — waiting to berth alongside Laphroaig"),
        ("BERTHING_B",       "🔗 Berthing alongside Laphroaig"),
        ("HOSE_CONNECT_B",   "🔧 Hose connected to Laphroaig — pumping starting"),
        ("DISCHARGING",      "⬇️ Offloading to Laphroaig — in progress"),
        ("CAST_OFF_B",       "↩️ Offload complete — casting off from Laphroaig"),
    ]},
    {"display": "Lock and Load — Laphroaig ← Sherlock",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Sherlock",
    ...
    {"display": "Lock and Offload — Sherlock → Laphroaig",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Laphroaig",
    ...
    {"display": "Lock and Load — Laphroaig ← Rathbone",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rathbone",
    ...
    {"display": "Lock and Offload — Rathbone → Laphroaig",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Laphroaig",
    ...
    {"display": "Lock and Load — Laphroaig ← Balham",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Balham",
    ...
    {"display": "Lock and Offload — Balham → Laphroaig",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Laphroaig",
    ...
    {"display": "Lock and Load — Laphroaig ← Bedford",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bedford",
    ...
    {"display": "Lock and Offload — Bedford → Laphroaig",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Laphroaig",
    ...
    {"display": "Lock and Load — Laphroaig ← Woodstock",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Woodstock",
    ...
    {"display": "Lock and Offload — Woodstock → Laphroaig",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Laphroaig",
    ...
    {"display": "Lock and Load — Laphroaig ← Bagshot",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bagshot",
    ...
    {"display": "Lock and Offload — Bagshot → Laphroaig",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Laphroaig",
    ...
    {"display": "Lock and Load — Laphroaig ← Amyla",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Amyla",
    ...
    {"display": "Lock and Offload — Amyla → Laphroaig",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Laphroaig",
    ...
    {"display": "Lock and Load — Laphroaig ← SantaMonica",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "SantaMonica",
    ...
    {"display": "Lock and Offload — SantaMonica → Laphroaig",
     "sim_value": "SantaMonica",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Laphroaig",
    ...
    {"display": "Lock and Load — Laphroaig ← Rahama",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rahama",
    ...
    {"display": "Lock and Offload — Rahama → Laphroaig",
     "sim_value": "Rahama",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Laphroaig",
    ...
    {"display": "Lock and Load — Rathbone ← Watson",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Watson",
    ...
    {"display": "Lock and Offload — Watson → Rathbone",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Rathbone",
     "locked_receiver": "Rathbone",
     "statuses": [
        ("SAILING_AB_LEG2",  "🚢 Inbound — will offload to Rathbone on arrival"),
        ("WAITING_BERTH_B",  "⏳ Arrived — waiting to berth alongside Rathbone"),
        ("BERTHING_B",       "🔗 Berthing alongside Rathbone"),
        ("HOSE_CONNECT_B",   "🔧 Hose connected to Rathbone — pumping starting"),
        ("DISCHARGING",      "⬇️ Offloading to Rathbone — in progress"),
        ("CAST_OFF_B",       "↩️ Offload complete — casting off from Rathbone"),
    ]},
    {"display": "Lock and Load — Rathbone ← Sherlock",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Sherlock",
    ...
    {"display": "Lock and Offload — Sherlock → Rathbone",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Rathbone",
    ...
    {"display": "Lock and Load — Rathbone ← Laphroaig",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Laphroaig",
    ...
    {"display": "Lock and Offload — Laphroaig → Rathbone",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Rathbone",
    ...
    {"display": "Lock and Load — Rathbone ← Balham",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Balham",
    ...
    {"display": "Lock and Offload — Balham → Rathbone",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Rathbone",
    ...
    {"display": "Lock and Load — Rathbone ← Bedford",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bedford",
    ...
    {"display": "Lock and Offload — Bedford → Rathbone",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Rathbone",
    ...
    {"display": "Lock and Load — Rathbone ← Woodstock",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Woodstock",
    ...
    {"display": "Lock and Offload — Woodstock → Rathbone",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Rathbone",
    ...
    {"display": "Lock and Load — Rathbone ← Bagshot",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bagshot",
    ...
    {"display": "Lock and Offload — Bagshot → Rathbone",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Rathbone",
    ...
    {"display": "Lock and Load — Rathbone ← Amyla",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Amyla",
    ...
    {"display": "Lock and Offload — Amyla → Rathbone",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Rathbone",
    ...
    {"display": "Lock and Load — Rathbone ← SantaMonica",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "SantaMonica",
    ...
    {"display": "Lock and Offload — SantaMonica → Rathbone",
     "sim_value": "SantaMonica",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Rathbone",
    ...
    {"display": "Lock and Load — Rathbone ← Rahama",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rahama",
    ...
    {"display": "Lock and Offload — Rahama → Rathbone",
     "sim_value": "Rahama",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Rathbone",
    ...
    {"display": "Lock and Load — Balham ← Watson",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Watson",
    ...
    {"display": "Lock and Offload — Watson → Balham",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Balham",
     "locked_receiver": "Balham",
     "statuses": [
        ("SAILING_AB_LEG2",  "🚢 Inbound — will offload to Balham on arrival"),
        ("WAITING_BERTH_B",  "⏳ Arrived — waiting to berth alongside Balham"),
        ("BERTHING_B",       "🔗 Berthing alongside Balham"),
        ("HOSE_CONNECT_B",   "🔧 Hose connected to Balham — pumping starting"),
        ("DISCHARGING",      "⬇️ Offloading to Balham — in progress"),
        ("CAST_OFF_B",       "↩️ Offload complete — casting off from Balham"),
    ]},
    {"display": "Lock and Load — Balham ← Sherlock",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Sherlock",
    ...
    {"display": "Lock and Offload — Sherlock → Balham",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Balham",
    ...
    {"display": "Lock and Load — Balham ← Laphroaig",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Laphroaig",
    ...
    {"display": "Lock and Offload — Laphroaig → Balham",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Balham",
    ...
    {"display": "Lock and Load — Balham ← Rathbone",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rathbone",
    ...
    {"display": "Lock and Offload — Rathbone → Balham",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Balham",
    ...
    {"display": "Lock and Load — Balham ← Bedford",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bedford",
    ...
    {"display": "Lock and Offload — Bedford → Balham",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Balham",
    ...
    {"display": "Lock and Load — Balham ← Woodstock",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Woodstock",
    ...
    {"display": "Lock and Offload — Woodstock → Balham",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Balham",
    ...
    {"display": "Lock and Load — Balham ← Bagshot",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bagshot",
    ...
    {"display": "Lock and Offload — Bagshot → Balham",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Balham",
    ...
    {"display": "Lock and Load — Balham ← Amyla",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Amyla",
    ...
    {"display": "Lock and Offload — Amyla → Balham",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Balham",
    ...
    {"display": "Lock and Load — Balham ← SantaMonica",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "SantaMonica",
    ...
    {"display": "Lock and Offload — SantaMonica → Balham",
     "sim_value": "SantaMonica",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Balham",
    ...
    {"display": "Lock and Load — Balham ← Rahama",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rahama",
    ...
    {"display": "Lock and Offload — Rahama → Balham",
     "sim_value": "Rahama",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Balham",
    ...
    {"display": "Lock and Load — Bedford ← Watson",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Watson",
    ...
    {"display": "Lock and Offload — Watson → Bedford",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bedford",
     "locked_receiver": "Bedford",
     "statuses": [
        ("SAILING_AB_LEG2",  "🚢 Inbound — will offload to Bedford on arrival"),
        ("WAITING_BERTH_B",  "⏳ Arrived — waiting to berth alongside Bedford"),
        ("BERTHING_B",       "🔗 Berthing alongside Bedford"),
        ("HOSE_CONNECT_B",   "🔧 Hose connected to Bedford — pumping starting"),
        ("DISCHARGING",      "⬇️ Offloading to Bedford — in progress"),
        ("CAST_OFF_B",       "↩️ Offload complete — casting off from Bedford"),
    ]},
    {"display": "Lock and Load — Bedford ← Sherlock",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Sherlock",
    ...
    {"display": "Lock and Offload — Sherlock → Bedford",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bedford",
    ...
    {"display": "Lock and Load — Bedford ← Laphroaig",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Laphroaig",
    ...
    {"display": "Lock and Offload — Laphroaig → Bedford",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bedford",
    ...
    {"display": "Lock and Load — Bedford ← Rathbone",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rathbone",
    ...
    {"display": "Lock and Offload — Rathbone → Bedford",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bedford",
    ...
    {"display": "Lock and Load — Bedford ← Balham",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Balham",
    ...
    {"display": "Lock and Offload — Balham → Bedford",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bedford",
    ...
    {"display": "Lock and Load — Bedford ← Woodstock",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Woodstock",
    ...
    {"display": "Lock and Offload — Woodstock → Bedford",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bedford",
    ...
    {"display": "Lock and Load — Bedford ← Bagshot",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bagshot",
    ...
    {"display": "Lock and Offload — Bagshot → Bedford",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bedford",
    ...
    {"display": "Lock and Load — Bedford ← Amyla",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Amyla",
    ...
    {"display": "Lock and Offload — Amyla → Bedford",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bedford",
    ...
    {"display": "Lock and Load — Bedford ← SantaMonica",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "SantaMonica",
    ...
    {"display": "Lock and Offload — SantaMonica → Bedford",
     "sim_value": "SantaMonica",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bedford",
    ...
    {"display": "Lock and Load — Bedford ← Rahama",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rahama",
    ...
    {"display": "Lock and Offload — Rahama → Bedford",
     "sim_value": "Rahama",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bedford",
    ...
    {"display": "Lock and Load — Woodstock ← Watson",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Watson",
    ...
    {"display": "Lock and Offload — Watson → Woodstock",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Woodstock",
     "locked_receiver": "Woodstock",
     "statuses": [
        ("SAILING_AB_LEG2",  "🚢 Inbound — will offload to Woodstock on arrival"),
        ("WAITING_BERTH_B",  "⏳ Arrived — waiting to berth alongside Woodstock"),
        ("BERTHING_B",       "🔗 Berthing alongside Woodstock"),
        ("HOSE_CONNECT_B",   "🔧 Hose connected to Woodstock — pumping starting"),
        ("DISCHARGING",      "⬇️ Offloading to Woodstock — in progress"),
        ("CAST_OFF_B",       "↩️ Offload complete — casting off from Woodstock"),
    ]},
    {"display": "Lock and Load — Woodstock ← Sherlock",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Sherlock",
    ...
    {"display": "Lock and Offload — Sherlock → Woodstock",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Woodstock",
    ...
    {"display": "Lock and Load — Woodstock ← Laphroaig",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Laphroaig",
    ...
    {"display": "Lock and Offload — Laphroaig → Woodstock",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Woodstock",
    ...
    {"display": "Lock and Load — Woodstock ← Rathbone",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rathbone",
    ...
    {"display": "Lock and Offload — Rathbone → Woodstock",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Woodstock",
    ...
    {"display": "Lock and Load — Woodstock ← Balham",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Balham",
    ...
    {"display": "Lock and Offload — Balham → Woodstock",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Woodstock",
    ...
    {"display": "Lock and Load — Woodstock ← Bedford",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bedford",
    ...
    {"display": "Lock and Offload — Bedford → Woodstock",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Woodstock",
    ...
    {"display": "Lock and Load — Woodstock ← Bagshot",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bagshot",
    ...
    {"display": "Lock and Offload — Bagshot → Woodstock",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Woodstock",
    ...
    {"display": "Lock and Load — Woodstock ← Amyla",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Amyla",
    ...
    {"display": "Lock and Offload — Amyla → Woodstock",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Woodstock",
    ...
    {"display": "Lock and Load — Woodstock ← SantaMonica",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "SantaMonica",
    ...
    {"display": "Lock and Offload — SantaMonica → Woodstock",
     "sim_value": "SantaMonica",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Woodstock",
    ...
    {"display": "Lock and Load — Woodstock ← Rahama",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rahama",
    ...
    {"display": "Lock and Offload — Rahama → Woodstock",
     "sim_value": "Rahama",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Woodstock",
    ...
    {"display": "Lock and Load — Bagshot ← Watson",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Watson",
    ...
    {"display": "Lock and Offload — Watson → Bagshot",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bagshot",
     "locked_receiver": "Bagshot",
     "statuses": [
        ("SAILING_AB_LEG2",  "🚢 Inbound — will offload to Bagshot on arrival"),
        ("WAITING_BERTH_B",  "⏳ Arrived — waiting to berth alongside Bagshot"),
        ("BERTHING_B",       "🔗 Berthing alongside Bagshot"),
        ("HOSE_CONNECT_B",   "🔧 Hose connected to Bagshot — pumping starting"),
        ("DISCHARGING",      "⬇️ Offloading to Bagshot — in progress"),
        ("CAST_OFF_B",       "↩️ Offload complete — casting off from Bagshot"),
    ]},
    {"display": "Lock and Load — Bagshot ← Sherlock",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Sherlock",
    ...
    {"display": "Lock and Offload — Sherlock → Bagshot",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bagshot",
    ...
    {"display": "Lock and Load — Bagshot ← Laphroaig",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Laphroaig",
    ...
    {"display": "Lock and Offload — Laphroaig → Bagshot",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bagshot",
    ...
    {"display": "Lock and Load — Bagshot ← Rathbone",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rathbone",
    ...
    {"display": "Lock and Offload — Rathbone → Bagshot",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bagshot",
    ...
    {"display": "Lock and Load — Bagshot ← Balham",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Balham",
    ...
    {"display": "Lock and Offload — Balham → Bagshot",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bagshot",
    ...
    {"display": "Lock and Load — Bagshot ← Bedford",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bedford",
    ...
    {"display": "Lock and Offload — Bedford → Bagshot",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bagshot",
    ...
    {"display": "Lock and Load — Bagshot ← Woodstock",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Woodstock",
    ...
    {"display": "Lock and Offload — Woodstock → Bagshot",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bagshot",
    ...
    {"display": "Lock and Load — Bagshot ← Amyla",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Amyla",
    ...
    {"display": "Lock and Offload — Amyla → Bagshot",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bagshot",
    ...
    {"display": "Lock and Load — Bagshot ← SantaMonica",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "SantaMonica",
    ...
    {"display": "Lock and Offload — SantaMonica → Bagshot",
     "sim_value": "SantaMonica",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bagshot",
    ...
    {"display": "Lock and Load — Bagshot ← Rahama",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rahama",
    ...
    {"display": "Lock and Offload — Rahama → Bagshot",
     "sim_value": "Rahama",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Bagshot",
    ...
    {"display": "Lock and Load — Amyla ← Watson",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Watson",
    ...
    {"display": "Lock and Offload — Watson → Amyla",
     "sim_value": "Watson",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Amyla",
     "locked_receiver": "Amyla",
     "statuses": [
        ("SAILING_AB_LEG2",  "🚢 Inbound — will offload to Amyla on arrival"),
        ("WAITING_BERTH_B",  "⏳ Arrived — waiting to berth alongside Amyla"),
        ("BERTHING_B",       "🔗 Berthing alongside Amyla"),
        ("HOSE_CONNECT_B",   "🔧 Hose connected to Amyla — pumping starting"),
        ("DISCHARGING",      "⬇️ Offloading to Amyla — in progress"),
        ("CAST_OFF_B",       "↩️ Offload complete — casting off from Amyla"),
    ]},
    {"display": "Lock and Load — Amyla ← Sherlock",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Sherlock",
    ...
    {"display": "Lock and Offload — Sherlock → Amyla",
     "sim_value": "Sherlock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Amyla",
    ...
    {"display": "Lock and Load — Amyla ← Laphroaig",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Laphroaig",
    ...
    {"display": "Lock and Offload — Laphroaig → Amyla",
     "sim_value": "Laphroaig",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Amyla",
    ...
    {"display": "Lock and Load — Amyla ← Rathbone",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rathbone",
    ...
    {"display": "Lock and Offload — Rathbone → Amyla",
     "sim_value": "Rathbone",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Amyla",
    ...
    {"display": "Lock and Load — Amyla ← Balham",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Balham",
    ...
    {"display": "Lock and Offload — Balham → Amyla",
     "sim_value": "Balham",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Amyla",
    ...
    {"display": "Lock and Load — Amyla ← Bedford",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bedford",
    ...
    {"display": "Lock and Offload — Bedford → Amyla",
     "sim_value": "Bedford",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Amyla",
    ...
    {"display": "Lock and Load — Amyla ← Woodstock",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Woodstock",
    ...
    {"display": "Lock and Offload — Woodstock → Amyla",
     "sim_value": "Woodstock",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Amyla",
    ...
    {"display": "Lock and Load — Amyla ← Bagshot",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Bagshot",
    ...
    {"display": "Lock and Offload — Bagshot → Amyla",
     "sim_value": "Bagshot",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Amyla",
    ...
    {"display": "Lock and Load — Amyla ← SantaMonica",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "SantaMonica",
    ...
    {"display": "Lock and Offload — SantaMonica → Amyla",
     "sim_value": "SantaMonica",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Amyla",
    ...
    {"display": "Lock and Load — Amyla ← Rahama",
     "sim_value": "Amyla",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_receiver": True,
     "locked_discharger": "Rahama",
    ...
    {"display": "Lock and Offload — Rahama → Amyla",
     "sim_value": "Rahama",
     "field_zone": "BIA", "target_mother": None, "target_storage": None,
     "mto_discharger": True,
     "mto_target_vessel": "Amyla",
    ...
    {"display": "Cawthorne Channel → BIA via MT SanBarth", "sim_value": "Cawthorne Channel (outbound)",
     "field_zone": "Transit", "target_storage": "Duke", "target_mother": "MTSanBarth",
     "statuses": [
        ("SAILING_D_CHANNEL",    "🚢 Point D → Cawthorne Channel (3h, tidal)"),
        ("SAILING_CH_TO_BW_OUT", "🚢 Channel → Breakwater (1h, tidal)"),
        ("SAILING_CROSS_BW_OUT", "🚢 Crossing Breakwater outbound (0.5h, tidal)"),
    ...
    {"display": "Returning Duke from BIA via MT SanBarth", "sim_value": "En Route BIA→Storage",
     "field_zone": "Transit", "target_storage": "Duke", "target_mother": "MTSanBarth",
     "statuses": [
        ("SAILING_B_TO_BW_IN",  "🚢 BIA → clear breakwater (1.5h)"),
        ("SAILING_CROSS_BW_IN", "🚢 Crossing Breakwater inbound (0.5h, tidal)"),
...
def run_sim(sim_days, chapel, jasmines, westmore, duke, starturn, pgm,
            bryanston, alkebulan, greeneagle, mtsanbarth,
            bryanston_api: float = 0.0,
            alkebulan_api: float = 0.0,
            greeneagle_api: float = 0.0,
            mtsanbarth_api: float = 0.0,
    ...
    mother_unavailability_json: JSON list of {mother, start_date, end_date} —
        scheduled periods when a primary mother is unavailable.  Daughters and
        MTSanBarth transloads are rerouted to other mothers during each window.
    """
    ...
    if custom_vessels_json and hasattr(mod, "add_custom_vessel"):
        try:
            ...
            _cv_list = []
        _valid_storages = {
            getattr(mod, "STORAGE_PRIMARY_NAME",   "Chapel"),
    ...
    _OPT_KEYS = [
        ...
        ("MTSANBARTH_OPTIM_THRESHOLD_FRAC", "sj_optim_threshold"),
        ("SANJULIAN_OPTIM_MIN_SPACE_BBL",  "sj_optim_min_space"),
    ]
    if opt_params_json:
    ...
    # alkebulan param retained for backward compat with Google Sheets column names;
    # it now seeds GreenEagle (the only remaining secondary mother after Alkebulan removal).
    # If both alkebulan and greeneagle are provided, take the larger non-zero value.
    _ge_seed = max(alkebulan, greeneagle) if (alkebulan > 0 or greeneagle > 0) else 0
    sim.mother_bbl["GreenEagle"] = min(_ge_seed, int(_mother_caps.get("GreenEagle", _default_cap)))
    sim.mother_bbl["MTSanBarth"]  = min(mtsanbarth,  int(_mother_caps.get("MTSanBarth", _default_cap)))
    if bryanston  > 0 and bryanston_api  > 0:
        sim.mother_api["Bryanston"]  = float(bryanston_api)
    _ge_api_seed = greeneagle_api if greeneagle_api > 0 else alkebulan_api
    if _ge_seed > 0 and _ge_api_seed > 0:
        sim.mother_api["GreenEagle"] = float(_ge_api_seed)
    if mtsanbarth  > 0 and mtsanbarth_api  > 0:
        sim.mother_api["MTSanBarth"]  = float(mtsanbarth_api)
    ...
    if vessel_states_json:
        ...
        for v in sim.vessels:
            ...
            if v.name in vs:
                ...
                #   Queued inbound discharger. Routes to transient on arrival.
                # Case C — is_mto_receiver (Lock and Load):
                #   Receiver vessel. Flag _mto_transient_since_day and set WAITING_BERTH_B.
                #   If locked_discharger is set, the auto-engine is suppressed for this
                #   receiver — only the named discharger may transfer to it.
                _mto_tv          = d.get("mto_target_vessel") or ""
                _is_mto_recv     = d.get("is_mto_receiver", False)
                _locked_disch    = d.get("locked_discharger", "") or ""   # receiver knows its discharger
                _locked_recv     = d.get("locked_receiver", "") or ""     # discharger knows its receiver
                ...
                if _is_mto_recv:
                    # Case C — receiver vessel (Lock and Load)
                    v._mto_transient_since_day = 0
                    v.status = "WAITING_BERTH_B"
                    v._mto_parcels_received    = 0

                    if _locked_disch:
                        # Hard-pin: only this specific discharger may transfer to this receiver.
                        # Store on vessel so the arrival handler and auto-engine both respect it.
                        v._mto_locked_discharger = _locked_disch

                        # Find the discharger vessel and force-pair it to this receiver
                        _disch_v = next(
                            (vv for vv in sim.vessels if vv.name == _locked_disch), None
                        )
                        if _disch_v is not None:
                            # Point the discharger at the receiver regardless of its current status
                            _disch_v._mto_target_vessel = v.name
                            if _disch_v.status in {
                                "SAILING_AB", "SAILING_AB_LEG2", "SAILING_CROSS_BW_AC",
                                "SAILING_BW_TO_FWY", "WAITING_TIDAL", "WAITING_DAYLIGHT",
                                "WAITING_RETURN_STOCK", "WAITING_FAIRWAY",
                            }:
                                # Inbound — arrival handler will route to receiver
                                _disch_v._mto_target_vessel = v.name
                            elif _disch_v.status in {
                                "DISCHARGING", "HOSE_CONNECT_B", "BERTHING_B", "WAITING_BERTH_B"
                            }:
                                # Already active at BIA — handled by Case A above (mto_target_vessel)
                                pass
                            sim.log_event(
                                0, v.name, "MTO_TRANSIENT_NOMINATED",
                                f"[MTO Lock and Load] {v.name} locked to receive from {_locked_disch} | "
                                f"on-board: {v.cargo_bbl:,.0f} bbl | "
                                f"auto-engine suppressed for this receiver",
                                voyage_num=v.current_voyage,
                            )
                            sim.log_event(
                                0, _disch_v.name, "MTO_DISCHARGE_TO_TRANSIENT",
                                f"[MTO Lock and Offload] {_locked_disch} locked to offload → {v.name} | "
                                f"cargo: {_disch_v.cargo_bbl:,.0f} bbl",
                                voyage_num=_disch_v.current_voyage,
                            )
    ...
    for v in sim.vessels:
        if v.name == "Bedford" and "Bedford" not in _vs_override and v.name not in _resumption_seed_names:
            ...
            sim.vessel_api[v.name] = getattr(mod, "IBOM_API", 32.0)
            # Reserve GreenEagle's berth for the full discharge window so no
            # other vessel attempts to berth there at t=0
            sim.mother_berth_free_at["GreenEagle"] = max(
                sim.mother_berth_free_at.get("GreenEagle", 0.0), _BALHAM_END
            )
        ...
        # MTSanBarth starts with no daughter alongside at t=0 (berth is free)
    ...
    # so the IDLE_A handler dispatches it to Chapel/JasmineS, not back to the buoy.
    ...
    for _exp_mn, _exp_days in _mother_export.items():
        ...
        # blocks daughters AND MTSanBarth transloads from targeting this mother.
    ...
    if mother_export_force_json:
        ...
        if isinstance(_raw_force, list):
            ...
            _sj_name        = getattr(mod, "MOTHER_QUATERNARY_NAME", "MTSanBarth")
            for _item in _raw_force:
                if not isinstance(_item, dict):
                    continue
                _mn   = _item.get("mother", "")
                _date = _item.get("date", "")
                if _mn not in _mother_names_f or _mn == _sj_name or not _date:
                    continue
                try:
    ...
    summary = dict(
        ...
        vessel_names    = [v.name for v in sim.vessels] + ["MTSanBarth"],
        ...
        **{f"final_{k}": float(v) for k, v in sim.mother_bbl.items()},
        ...
        # MTSanBarth-specific metrics
        mtsanbarth_total_transloaded = float(getattr(sim, "mtsanbarth_total_transloaded", 0.0)),
        final_mtsanbarth_bbl         = float(getattr(sim, "final_mtsanbarth_bbl",
                                            sim.mother_bbl.get("MTSanBarth", 0.0))),
        final_mtsanbarth_api         = round(float(getattr(sim, "final_mtsanbarth_api",
                                            sim.mother_api.get("MTSanBarth", 0.0))), 2),
    )
...
def run_optimizer(base_params_json: str):
    ...
    # MTSanBarth optimisation: two targeted combinations.
    _sj_optim_combos         = [(0.15, 25_000), (0.25, 50_000)]
    ...
    _orig_sj_thr = getattr(mod, "MTSANBARTH_OPTIM_THRESHOLD_FRAC", 0.25)
    _orig_sj_spc = getattr(mod, "SANJULIAN_OPTIM_MIN_SPACE_BBL",  50_000)
    ...
    def _score(S, log_df, tl_df):
        ...
        storage_names = ["Chapel", "JasmineS", "Westmore", "Duke", "Starturn", "PGM"]
        ...
        # High-production storages (Chapel, JasmineS) that spend a large
        ...
        # ── MTSanBarth utilisation score ──────────────────────────────────
        # Reward scenarios where MTSanBarth transloads frequently (short dwell
        # time between receiving 2nd parcel and starting offload) and penalise
        # scenarios where she holds volume for extended periods near capacity.
        sj_transload_starts = log_df[log_df["Event"] == "SJ_TRANSLOAD_START"] \
            if not log_df.empty else pd.DataFrame()
        n_sj_cycles = len(sj_transload_starts)
        # Average MTSanBarth volume (as % of capacity) over the sim — lower is better
        sj_cap_val = getattr(mod, "MTSANBARTH_CAPACITY_BBL", 440_000)
        if "MTSanBarth_bbl" in tl_df.columns and not tl_df.empty:
            sj_avg_pct = float(tl_df["MTSanBarth_bbl"].mean()) / max(1, sj_cap_val)
            # Time MTSanBarth spent ≥70% full (holding too long)
            sj_high_frac = float((tl_df["MTSanBarth_bbl"] >= 0.70 * sj_cap_val).mean())
        else:
            sj_avg_pct   = 0.0
            sj_high_frac = 0.0
        # Base score from cycle count (each cycle = 20 points, cap at 100)
        sj_cycle_score = min(100.0, n_sj_cycles * 20.0)
        # Penalise sustained high volume — dwell penalty: -3 pts per % above 70% dwell time
        sj_dwell_penalty = min(50.0, sj_high_frac * 100.0 * 3.0)
        sj_score = max(0.0, sj_cycle_score - sj_dwell_penalty)
        ...
        if sj_high_frac > 0.30: bottlenecks.append(f"MT SanBarth holding volume too long ({sj_high_frac*100:.0f}% of time ≥70% full)")
        ...
        # ── Storage utilisation ──────────────────────────────────────────
        su = {}
        for sn in ["Chapel","JasmineS","Westmore","Duke","Starturn","PGM"]:
    ...
    try:
        for rank, (dsf, pft, expw, (bstart, bend), (sj_thr, sj_spc), mto_parcels) in enumerate(_grid, 1):
            ...
            try:
                ...
                _opt_scenario_json = json.dumps(dict(
                    ...
                    sj_optim_threshold       = float(sj_thr),
                    sj_optim_min_space       = int(sj_spc),
                ))
                _log, _tl, S = run_sim(
                    sim_days            = base.get("sim_days", 14),
                    chapel              = base.get("chapel",   216_000),   # 80% of 270k
                ...
                all_results.append(dict(
                    ...
                    label=(f"dsf={dsf:.2f} pft={pft//1000}k expw={expw}h "
                           f"b={bstart}-{bend} sj_thr={sj_thr:.2f} sj_spc={sj_spc//1000}k"
    ...
    if not all_results:
        ...
        _log, _tl, S = run_sim(
            sim_days=base.get("sim_days",14),
            chapel=base.get("chapel",216_000), jasmines=base.get("jasmines",232_000),
            westmore=base.get("westmore",216_000), duke=base.get("duke",72_000),
            starturn=base.get("starturn",56_000), pgm=base.get("pgm",32_000),
            bryanston=base.get("bryanston",450_000), alkebulan=0,
            greeneagle=base.get("greeneagle",300_000), mtsanbarth=base.get("mtsanbarth",450_000),
            ...
            prod_starturn=base.get("prod_starturn",350), prod_pgm=base.get("prod_pgm",40),
            prod_ibom=base.get("prod_ibom",165),
    ...
    for r in all_results:
        ...
        rows.append({
            ...
            "MTSanBarth": sc.get("sj_score", 0),
            "SJ Cycles": sc.get("sj_cycles", 0),
            ...
            "sj_thr": pr.get("sj_optim_threshold", 0.25),
            "sj_spc_k": pr.get("sj_optim_min_space", 50_000) // 1000,
        })
...
def gs_load_volumes(sheet_id, creds_json):
    ...
    try:
        ...
        KNOWN = {"chapel_bbl", "jasmines_bbl", "bryanston_bbl",
                 "timestamp", "sim_days", "prod_chapel_bph"}
...
def capacity_recommendations(S, params, tl_df, mod):
    ...
    prod_pgm      = params.get("prod_pgm",      getattr(mod, "PGM_PRODUCTION_RATE_BPH", 40))
    prod_ibom   = params.get("prod_ibom",   getattr(mod, "IBOM_LOAD_RATE_BPH",
                             getattr(mod, "POINT_F_LOAD_RATE_BPH", 165)))
    total_prod_bpd = (prod_chapel + prod_jasmines + prod_westmore + prod_duke + prod_starturn + prod_pgm + prod_ibom) * 24
...
def chart_util(tl_df):
    items = [("Chapel","Chapel_bbl",270_000),("JasmineS","JasmineS_bbl",290_000),
             ...
             ("Starturn","Starturn_bbl",70_000),("PGM","PGM_bbl",40_000)]
    fig = go.Figure()
...
def chart_mothers(tl_df, export_trigger, cap_by_name, export_trigger_by_name=None):
    ...
    for name, col in [("Bryanston","Bryanston_bbl"),
                       ...
                       ("MTSanBarth","MTSanBarth_bbl")]:
        if col in tl_df.columns:
            _dash = "dash" if name == "MTSanBarth" else "solid"
            fig.add_trace(go.Scatter(x=tl_df.Time, y=tl_df[col], name=name,
                fill="tozeroy", fillcolor=fills.get(name, "rgba(0,0,0,0.05)"),
                line=dict(color=MOTHER_COLORS[name], width=2, dash=_dash)))
    ...
    _cap_sj  = int(cap_by_name.get("MTSanBarth", _cap_bry))
    ...
    fig.add_hline(y=_cap_sj, line=dict(color="#94a3b8", dash="dot"),
                  annotation_text=f"MT SanBarth capacity ({_cap_sj:,} bbl)",
                  annotation_font_color="#e2e8f0")
    fig.update_layout(height=320, margin=_MARGIN,
                      title="BIA Mother Vessels — Volume (MT SanBarth: transload-only, no export)",
                      **_DARK, legend=dict(bgcolor="#ffffff"))
    fig.update_yaxes(tickformat=",", **_GRID, title_text="bbl")
    fig.update_xaxes(**_GRID)
    return fig
...
def chart_gantt(tl_df, vessel_names, log_df=None):
    ...
    MTSanBarth is rendered as an additional row below the daughter vessels,
    showing its transload status (BERTHING_B / HOSE_CONNECT_B / DISCHARGING /
    CAST_OFF_B) whenever it is pumping to a primary mother.
    """
    ...
    # MTSanBarth transload statuses — share the "At BIA" category so the bar
    # colour matches a daughter vessel discharging, but also add a dedicated
    # "Transloading" category for the label.
    _SJ_ACTIVE_ST = {"BERTHING_B","HOSE_CONNECT_B","DISCHARGING","CAST_OFF_B"}
    ...
    _CATS = {
        ...
        "Idle"         : ("#475569", "💤 Idle"),
        "Transloading" : ("#000000", "⇄ MT SanBarth Transloading"),
    }
    ...
    def _sj_cat(st):
        """Category for MTSanBarth status column."""
        if st in _SJ_ACTIVE_ST:
            return "Transloading"
        return "Idle"

    fig = go.Figure()

    # MTSanBarth occupies y=0, daughter vessels above it
    _sj_has_col = "MTSanBarth" in tl_df.columns
    _sj_offset  = 1 if _sj_has_col else 0

    vessels_ordered = list(reversed(vessel_names))   # top vessel = first in list
    # y positions: daughter vessels start at _sj_offset so MTSanBarth sits at bottom
    y_pos = {n: i + _sj_offset for i, n in enumerate(vessels_ordered)}
    _legend_added = set()
    ...
    # ── MTSanBarth row — transload activity at y=0 ────────────────────────────
    if _sj_has_col:
        _sj_col   = "#000000"  # deep black — matches MOTHER_COLORS["MTSanBarth"]
        _sj_idle  = "#2d3748"  # dark slate for idle periods
        sub_sj = tl_df[["Day", "Time", "MTSanBarth"]].dropna(subset=["MTSanBarth"]).copy()
        if not sub_sj.empty:
            sub_sj["xf"]  = (sub_sj["Day"] - 1) + sub_sj["Time"].apply(
                lambda d: (d.hour + d.minute / 60) / 24
            )
            sub_sj["cat"] = sub_sj["MTSanBarth"].apply(_sj_cat)
            sub_sj["blk"] = (sub_sj["cat"] != sub_sj["cat"].shift()).cumsum()

            for (cat, _blk), grp in sub_sj.groupby(["cat", "blk"], sort=False):
                if cat == "Idle":
                    continue   # don't clutter chart with MTSanBarth idle spans
                x0  = float(grp["xf"].iloc[0])
                x1  = float(grp["xf"].iloc[-1]) + (1.0 / SLOTS_PER_DAY)
                dur = x1 - x0
                rep_st  = grp["MTSanBarth"].mode().iloc[0]
                lbl     = STATUS_LABELS.get(rep_st, rep_st)
                d0, d1  = int(grp["Day"].iloc[0]), int(grp["Day"].iloc[-1])
                day_lbl = f"Day {d0}" if d0 == d1 else f"Day {d0}–{d1}"
                t0_s    = grp["Time"].iloc[0].strftime("%H:%M")
                t1_s    = grp["Time"].iloc[-1].strftime("%H:%M")
                hover   = (
                    f"<b>MT SanBarth</b>  ·  <b>⇄ Transloading</b><br>"
                    f"{lbl}<br>"
                    f"{day_lbl}  {t0_s} → {t1_s}<br>"
                    f"Duration: {dur*24:.1f} h"
                )
                show_leg_sj = "Transloading" not in _legend_added
                if show_leg_sj:
                    _legend_added.add("Transloading")
                fig.add_trace(go.Bar(
                    x=[dur], y=[0], base=[x0],
                    orientation="h", width=0.60,
                    marker=dict(
                        color=_sj_col, opacity=0.92,
                        line=dict(color="rgba(0,0,0,0.3)", width=0.6),
                    ),
                    name=_CATS["Transloading"][1],
                    legendgroup="Transloading",
                    showlegend=show_leg_sj,
                    hovertemplate=hover + "<extra></extra>",
                ))
    ...
    # All rows: daughter vessels + MTSanBarth at bottom
    _all_rows_ordered = vessels_ordered + (["MTSanBarth"] if _sj_has_col else [])
    _all_y_vals       = [y_pos[n] for n in vessels_ordered] + ([0] if _sj_has_col else [])
    _all_tick_text    = [
        ...
        ["<span style=\"color:#ffffff;font-weight:700\">⇄ MT SanBarth</span>"]
        if _sj_has_col else []
    )
    _total_rows = len(vessel_names) + _sj_offset
...
def _effective_load_cap(vessel_name, storage_name, mod):
    ...
    if storage_name == getattr(mod, "STORAGE_SECONDARY_NAME", "JasmineS"):
        ...
        cap = int(round(base_cap * getattr(mod, "WESTMORE_LOAD_CAP_MULTIPLIER", 0.82)))
...
def render_mother_cards(gs_vols, manual_mother, mod):
    ...
    for i, (mn, mk) in enumerate([
        ...
        ("GreenEagle","greeneagle"), ("MTSanBarth","mtsanbarth")
    ]):
        ...
        _sj_cap = getattr(mod, "MTSANBARTH_CAPACITY_BBL", cap)
        _sj_rate = getattr(mod, "MTSANBARTH_TRANSLOAD_RATE_BPH", 12_000)

        if mn == "MTSanBarth":
            # MTSanBarth never exports — show transload status instead
            _sj_pct = max(4, min(100, int(bbl/_sj_cap*100))) if _sj_cap else 0
            _t1_pct = int(_sj_cap / _sj_cap * 100)  # 100%
            flag = (
                '<span style="background:#000000;color:#ffffff;padding:2px 8px;border-radius:4px;font-size:11px;font-weight:700">⇄ Transloads to primary mothers</span>'
                '<br><span style="color:#94a3b8;font-size:10px">'
                f'Rate: {_sj_rate:,} bph · No export</span>'
            )
            pct = _sj_pct
        else:
            above = bbl >= exp_t
...
def main():
    ...
    MOTHER_CAP_BY_NAME = getattr(mod, "MOTHER_CAPACITY_BY_NAME", {
        ...
        "GreenEagle": int(mod.MOTHER_CAPACITY_BBL),
        "GreenEagle": int(mod.MOTHER_CAPACITY_BBL),
        "MTSanBarth": int(getattr(mod, "MTSANBARTH_CAPACITY_BBL", mod.MOTHER_CAPACITY_BBL)),
    })
    ...
    _mother_opts = list(getattr(mod, "MOTHER_NAMES", ["Bryanston", "GreenEagle", "MTSanBarth"]))
    ...
    with _ctrl_day1:
        startup_day_disable_point_b_priority = st.toggle(
            ...
            value=True,
            help=(
                "Day 1 only: Point B assignment uses the mother nominations set in each "
                "vessel row below. Day 2 onward: strict automatic priority applies."
            ),
        ...
        with _day1_left:
            ...
            with st.container():
                ...
                _cv_perms_input = st.multiselect(
                    ...
                    default=[_cv_storage_opts[0], _cv_storage_opts[1]],  # Chapel + JasmineS
                    key="cv_perms_input",
                    help=(
                        "Storages this vessel may load from. "
                        "Select at least one. Defaults to Chapel and JasmineS."
                    ),
                )
    ...
    with _ctrl_inputs:
        ...
        with _r2c3:
            prod_pgm = st.number_input("PGM (Point G)", 0, 200,
                int(getattr(mod, "PGM_PRODUCTION_RATE_BPH", 40)), step=5, key="pr_pgm")
        ...
        st.caption(
            ...
            "During a mother's window she cannot receive daughters or MTSanBarth transloads — "
    ...
    with _ctrl_data:
        ...
        def _parse_stock_csv(file_bytes):
            ...
            raw_date = _cell(rows, 1, 4)  # "05/04/2026 07:00:00"
            try:
                dt = datetime.datetime.strptime(raw_date.split()[0], "%m/%d/%Y")
            ...
            #   Chapel   (r9)  → col 8   Duke     (r10) → col 7
            ...
            # col 10 = comment text
            # Loading-from: col 11=Chapel, 12=JasmineS, 13=Westmore, 14=Duke,
            #               15=Ibom, 16=Petralon54, 17=Asaramatoru
            # Discharging-to: col 18=GreenEagle/SanBarth, 19=Bryanston
            # Scheduled Loading cols: 11=Chapel 12=JasmineS 13=Westmore
            ...
            # Find MTO dischargers: negative value in col 21 (excluding the receiver row)
            _mto_dischargers = {}  # {vessel_name: volume_discharged_bbl}
            for _mr in _MTO_SCAN_ROWS:
                _v21 = _num(rows, _mr, 21)
                if _v21 < 0 and _mr != _mto_receiver_row:
                    _raw = _cell(rows, _mr, 2).lower()
                    for _dn in _ALL_DAUGHTER_NAMES:
                        if _dn.lower() in _raw:
                            _mto_dischargers[_dn] = abs(_v21)
                            break
            ...
            # the confirm step knows MTSanBarth is discharging to that mother
            _sj_dv = {
                "name":             "MTSanBarth",
                "cargo_bbl":        mother_volumes.get("MTSanBarth", 0),
                "status":           "DISCHARGING" if _mtsanbarth_target_mom else "IDLE_B",
                "assigned_storage": "",
                "target_mother":    _mtsanbarth_target_mom,
                "notes":            f"Discharging to {_mtsanbarth_target_mom}" if _mtsanbarth_target_mom else "",
            }
            ...
            return {
                ...
                "mtsanbarth_vessel":   _sj_dv,
                "ibom_loading_vessel": _ibom_loader,
                "extraction_notes":   (
                    f"Parsed directly from CSV. Ibom stock: {_ibom_stock:,} bbl. "
                    + (f"MTSanBarth discharging to {_mtsanbarth_target_mom}. " if _mtsanbarth_target_mom else "")
        ...
        if st.session_state.get("_pdf_extracted"):
            ...
            with st.expander("📝 Review & Adjust Extracted Data", expanded=True):
                ...
                _sv_specs = [
                    ...
                    ("Duke",      90_000), ("Starturn",  70_000), ("PGM",      40_000),
                ]
                ...
                # Capacities from sim: Bryanston 550k, GreenEagle 750k, MTSanBarth 450k
                ...
                _mv_specs = [
                    ...
                    ("MTSanBarth", "MT SanBarth",int(_mv_cap_map.get("MTSanBarth", 450_000))),
                ]
                ...
                for _dvi, _dv in enumerate(_ex.get("daughter_vessels", [])):
                    ...
                    with _dc[1]:
                        ...
                        _dv["cargo_bbl"] = st.number_input(
                            "cargo", 0, _dv_cap * 2, _dv_cargo_val,
                    ...
                    with _dc[3]:
                        ...
                        _dv["assigned_storage"]  = _sel_entry.get("target_storage") or (
                            _sel_sv if _sel_sv in {"Chapel","JasmineS","Westmore","Duke","Starturn","PGM","Ibom"} else ""
                        )
                        _dv["target_mother"]      = _sel_entry.get("target_mother") or (
                            _sel_sv if _sel_sv in {"Bryanston","GreenEagle","MTSanBarth"} else ""
                        )
                        _dv["is_mto_receiver"]    = bool(_sel_entry.get("mto_receiver", False))
                        _dv["mto_target_vessel"]  = _sel_entry.get("mto_target_vessel", "")
                        _dv["locked_discharger"]  = _sel_entry.get("locked_discharger", "")
                        _dv["locked_receiver"]    = _sel_entry.get("locked_receiver", "")
                ...
                _sj_dv = _ex.get("mtsanbarth_vessel", {})
                if _sj_dv:
                    st.markdown("**MT SanBarth (transloading vessel)**")
                    _sj_cols = st.columns([2, 2, 2])
                    with _sj_cols[0]:
                        _sj_dv["cargo_bbl"] = st.number_input(
                            "SanBarth cargo (bbl)", 0, 500_000,
                            int(_sj_dv.get("cargo_bbl", 0)),
                            step=10_000, key="pdf_sj_cargo",
                        )
                    with _sj_cols[1]:
                        _sj_status_opts = ["IDLE_B", "DISCHARGING", "HOSE_CONNECT_B",
                                           "BERTHING_B", "WAITING_BERTH_B", "CAST_OFF_B"]
                        _sj_cur_st = _sj_dv.get("status", "IDLE_B")
                        _sj_st_idx = _sj_status_opts.index(_sj_cur_st) if _sj_cur_st in _sj_status_opts else 0
                        _sj_dv["status"] = st.selectbox(
                            "SanBarth status", _sj_status_opts,
                            index=_sj_st_idx, key="pdf_sj_status",
                        )
                    with _sj_cols[2]:
                        _sj_mom_opts = ["", "GreenEagle", "Bryanston"]
                        _sj_cur_mom  = _sj_dv.get("target_mother", "") or ""
                        _sj_mom_idx  = _sj_mom_opts.index(_sj_cur_mom) if _sj_cur_mom in _sj_mom_opts else 0
                        _sj_dv["target_mother"] = st.selectbox(
                            "SanBarth discharging to", _sj_mom_opts,
                            index=_sj_mom_idx, key="pdf_sj_mom",
                            help="Which mother vessel SanBarth is transferring cargo to.",
                        )
                    _ex["mtsanbarth_vessel"] = _sj_dv
                ...
                with _confirm_col:
                    if st.button(
                        ...
                        for _mvk in ["Bryanston", "GreenEagle", "MTSanBarth"]:
                        ...
                        _sp_map_pdf = getattr(mod, "STORAGE_POINT", {
                            "Chapel": "A", "JasmineS": "A", "Westmore": "C",
                        ...
                        for _dv in _ex.get("daughter_vessels", []):
                            ...
                            if _vis_recv:
                                # MTO receiver — location is the vessel's own name (catalogue entry)
                                _vloc = _vname
                            elif _vmto_tv:
                                ...
                                _vloc = _vstor if _vstor else "Chapel"
                    ...
                    "locked_discharger":  _vd.get("locked_discharger", "") or "",
                    "locked_receiver":    _vd.get("locked_receiver", "") or "",
                        ...
                        # Add MTSanBarth vessel state (discharge pairing from CSV)
                        _sj_dv = _ex.get("mtsanbarth_vessel")
                        if _sj_dv:
                            ...
                            _vp_states_pdf["MTSanBarth"] = {
                                ...
                                "target_storage": None,
                                "target_mother":  _sj_mom or None,
                                "cargo_api":      0.0,
                                "hose_elapsed_hours": 0.0,
                                "already_transferred_bbl": 0,
                                "notes":          _sj_dv.get("notes", ""),
                            }
                        ...
                        st.session_state["vp_mother_vols"]   = {
                            ...
                            "mtsanbarth":  int(_ex.get("mother_volumes", {}).get("MTSanBarth", 0)),
                        }
                        st.session_state["vp_mother_apis"]  = {
                            "bryanston": 33.0, "greeneagle": 38.0, "mtsanbarth": 33.0,
                        }
        ...
        if tide_file is not None:
            st.session_state["_tide_file_cache"] = tide_file
    ...
    # Tidal file comes from the Data & Constraints tab uploader
    tide_file  = st.session_state.get("_tide_file_cache")

    # ── Pre-populate UI widget keys from vp_vessel_states BEFORE widgets render ──
    # ALWAYS overwrite widget keys when vp_confirmed is set — the CSV import
    # data is authoritative and must win over any previous default values.
    if st.session_state.get("vp_confirmed") and st.session_state.get("vp_vessel_states"):
    ...
    if not gs_vols:
        with st.expander("✏️ Enter 08:00 storage & mother volumes",
            ...
            mv = st.columns(4)
            # Default startup: Bryanston 450k @ 33°, GreenEagle 300k @ 38°, MTSanBarth 450k @ 33°
            _mother_vol_defaults = {"Bryanston": 450_000, "GreenEagle": 300_000, "MTSanBarth": 450_000}
            ...
            _mother_api_defaults = {"Bryanston": 33.00, "GreenEagle": 38.00, "MTSanBarth": 33.00}
            manual_mother_api = {}
            for _j2, _mn2 in enumerate(["Bryanston", "GreenEagle", "MTSanBarth"]):
                with _mapi_ui_cols[_j2]:
                    _stock_vol = manual_mother.get(_mn2.lower(), 0)
                    _api_val = st.number_input(
                        f"{_mn2} API°",
                        min_value=0.0, max_value=60.0,
                        value=float(_mother_api_defaults[_mn2]),
                        step=0.1, format="%.2f",
                        key=f"mapi_{_mn2}",
        ...
        with st.expander(
            ...
            for vn in missing_vessels:
                ...
                if _is_watson:
                    ...
                    # SantaMonica loads from Chapel (A), Duke (D), Starturn (E), PGM (G)
                    _loc_opts = [e["display"] for e in LOCATION_CATALOGUE
                                 if e["field_zone"] in ("SanBarth", "Awoba", "Dawes", "PGM", "BIA", "Transit")]
                else:
                ...
                with rc[1]:
                    ...
                    if _is_ibom_vessel:
                        ...
                        # Default: returning empty from BIA toward SanBarth (Chapel/JasmineS)
                        try: _default_loc_i = _loc_opts.index("Returning → SanBarth (Chapel/JasmineS)")
                        except ValueError: pass
                ...
                _mto_target_vessel = _loc_entry.get("mto_target_vessel", "")  # e.g. "Watson"
                ...
                if _is_bia_loc:
                    ...
                    if _is_mto_receiver:
                        # LOCK AND LOAD — receiver shows its locked discharger
                        _lkd = _loc_entry.get("locked_discharger", "")
                        if _lkd:
                            st.success(
                                f"🔒 **Lock and Load** — **{vn}** will receive cargo "
                                f"exclusively from **{_lkd}**. "
                                f"Set {_lkd}'s location to "
                                f"**'Lock and Offload — {_lkd} → {vn}'**.",
                                icon="📦",
                            )
                        else:
                            st.info(
                                f"**MTO Receiver** — {vn} accumulates cargo from "
                                f"a discharger at BIA.",
                                icon="📦",
                            )

                    elif _is_mto_discharger:
                        # LOCK AND OFFLOAD — discharger shows its locked receiver
                        _lkd_recv = _loc_entry.get("locked_receiver", "") or _mto_target_vessel
                        st.success(
                            f"🔒 **Lock and Offload** — **{vn}** will pump its full "
                            f"cargo to **{_lkd_recv}** at standard discharge rate. "
                            f"Set {_lkd_recv}'s location to "
                            f"**'Lock and Load — {_lkd_recv} ← {vn}'**.",
                            icon="⬇️",
                        )
                        _bia_mto_target = _mto_target_vessel

                        # Hose elapsed for MTO discharge
                        if st_v == "HOSE_CONNECT_B":
                            _hose_max = float(getattr(mod, "HOSE_CONNECTION_HOURS", 2.0))
                            _bia_hose_elapsed = st.number_input(
                                "Hose elapsed (h)", min_value=0.0, max_value=_hose_max,
                                value=0.0, step=0.25, key=f"vbia_hose_{vn}",
                                label_visibility="visible",
                                help=f"Hours of MTO hose connection already completed (0–{_hose_max:.1f} h).",
                            )
                ...
                manual_states[vn] = {
                    ...
                    "mto_target_vessel":     _bia_mto_target,
    ...
    # MTSanBarth is the transloading mother — it sits at BIA and discharges
    # accumulated cargo to a primary mother. Its state is separate from the
    # daughter vessel loop above because it is a mother, not a daughter.
    st.markdown("---")
    st.markdown("**🛢️ MT SanBarth — Startup Position**")
    st.caption(
        "Set MT SanBarth's opening stock and discharge allocation. "
        "If she is currently discharging to a primary mother, select the mother below."
    )

    _sj_name      = getattr(mod, "MOTHER_QUATERNARY_NAME", "MTSanBarth")
    _sj_cap       = int(getattr(mod, "MTSANBARTH_CAPACITY_BBL",
                                 getattr(mod, "MOTHER_CAPACITY_BBL", 450_000)))
    _sj_all_moms  = [m for m in list(getattr(mod, "MOTHER_NAMES",
                                             ["Bryanston", "GreenEagle", "MTSanBarth"]))
                     if m != _sj_name]   # primary mothers only

    _sj_c1, _sj_c2, _sj_c3, _sj_c4 = st.columns([2, 2, 2, 2])

    with _sj_c1:
        _sj_cargo = st.number_input(
            "MT SanBarth cargo (bbl)",
            min_value=0, max_value=_sj_cap * 2,
            value=st.session_state.get("mv_MTSanBarth", 0),
            step=10_000, key="sj_cargo_bbl",
            help=f"Volume currently on board MT SanBarth. Capacity: {_sj_cap:,} bbl.",
        )
        if _sj_cargo > _sj_cap:
            st.caption(f"⚠️ {_sj_cargo - _sj_cap:,} bbl over capacity → excess load")

    _sj_status_opts = [
        ("IDLE_B",           "🟢 Idle at BIA — no active discharge"),
        ("DISCHARGING",      "⬇️ Discharging to mother — in progress"),
        ("HOSE_CONNECT_B",   "🔧 Hose connecting to mother"),
        ("BERTHING_B",       "🔗 Berthing alongside mother"),
        ("WAITING_BERTH_B",  "⏳ Arrived BIA — waiting for mother berth"),
        ("CAST_OFF_B",       "↩️ Discharge complete — casting off"),
        ("WAITING_MOTHER_RETURN",   "⏳ Waiting — mother away at export"),
        ("WAITING_MOTHER_CAPACITY", "⏳ Waiting — mother vessel full"),
    ]
    _sj_stat_labels = [lbl for _, lbl in _sj_status_opts]
    _sj_stat_codes  = {lbl: code for code, lbl in _sj_status_opts}

    # Resolve default status from vp_vessel_states (if CSV was imported)
    _sj_vp = st.session_state.get("vp_vessel_states", {}).get(_sj_name, {})
    _sj_def_code = _sj_vp.get("status", "IDLE_B")
    _sj_def_lbl  = next((lbl for code, lbl in _sj_status_opts if code == _sj_def_code),
                        _sj_stat_labels[0])
    _sj_def_idx  = _sj_stat_labels.index(_sj_def_lbl)

    with _sj_c2:
        _sj_sel_lbl = st.selectbox(
            "MT SanBarth status",
            options=_sj_stat_labels,
            index=_sj_def_idx,
            key="sj_status_sel",
            help="Select MT SanBarth's operational status at 08:00.",
        )
        _sj_status = _sj_stat_codes[_sj_sel_lbl]

    _sj_show_mom = _sj_status in {
        "DISCHARGING", "HOSE_CONNECT_B", "BERTHING_B",
        "WAITING_BERTH_B", "CAST_OFF_B", "WAITING_MOTHER_CAPACITY",
    }

    _sj_mom_sel = None
    with _sj_c3:
        if _sj_show_mom:
            _sj_vp_mom = _sj_vp.get("target_mother", "") or ""
            _sj_mom_def_idx = (_sj_all_moms.index(_sj_vp_mom)
                               if _sj_vp_mom in _sj_all_moms else 0)
            _sj_mom_sel = st.selectbox(
                "Discharging to",
                options=_sj_all_moms,
                index=_sj_mom_def_idx,
                key="sj_mother_sel",
                help="Which primary mother MT SanBarth is currently discharging to.",
            )
        else:
            st.markdown(
                '<div style="padding-top:28px;font-size:12px;color:#94a3b8">— no discharge active —</div>',
                unsafe_allow_html=True
            )

    with _sj_c4:
        if _sj_cargo > 0 and _sj_status in {
            "DISCHARGING", "HOSE_CONNECT_B", "BERTHING_B",
            "WAITING_BERTH_B", "IDLE_B", "CAST_OFF_B",
        }:
            _sj_api_def = float(_sj_vp.get("cargo_api", 33.0) or 33.0)
            _sj_api = st.number_input(
                "Cargo API (°)",
                min_value=10.0, max_value=60.0,
                value=_sj_api_def, step=0.5,
                key="sj_cargo_api",
                help="API gravity of MT SanBarth's current stock.",
            )
        else:
            _sj_api = 0.0
            st.markdown(
                '<div style="padding-top:28px;font-size:12px;color:#94a3b8">—</div>',
                unsafe_allow_html=True
            )

    # Seed MTSanBarth into manual_states and mother volumes so the sim picks it up
    manual_states[_sj_name] = {
        "status":        _sj_status,
        "cargo_bbl":     _sj_cargo,
        "cargo_api":     _sj_api,
        "location":      _sj_mom_sel if _sj_mom_sel else _sj_name,
        "target_storage": None,
        "target_mother": _sj_mom_sel or None,
        "mto_target_vessel": "",
    ...
    # Also update mother volume so the initial mother_bbl is correct
    if "mtsanbarth" not in manual_mother or manual_mother["mtsanbarth"] == 0:
        manual_mother["mtsanbarth"] = _sj_cargo
    ...
    # Get primary mothers (exclude MTSanBarth)
    _exp_primary_mothers = [
    ...
    params = dict(
        ...
        chapel    = _p("chapel",    manual_storage, "Chapel",   int(SCAP["Chapel"]   * 0.80)),
        ...
        pgm       = _p("pgm",       manual_storage, "PGM",      int(SCAP.get("PGM", 40_000) * 0.80)),
        # Mother defaults: Bryanston 450k@33°, GreenEagle 300k@38°, MTSanBarth 450k@33°
        ...
        mtsanbarth = _p("mtsanbarth", manual_mother, "mtsanbarth", 450_000),
        ...
        mtsanbarth_api  = gs_vols.get("mtsanbarth_api",  manual_mother_api.get("mtsanbarth",  33.0)),
    )
    ...
    if _vp_states and st.session_state.get("vp_confirmed"):
        for _vn, _vd in _vp_states.items():
            ...
            if fleet_df.empty or _vn not in fleet_df["vessel"].values:
                ...
                _sim_loc = (
                    _vloc if _vloc in {
                        "Chapel","JasmineS","Westmore","Duke","Starturn","PGM",
                        "Ibom","Bryanston","GreenEagle","MTSanBarth",
                        "Fairway Buoy","Fairway",
                        "En Route SanBarth→BIA","En Route BIA→Storage",
                        "Breakwater (outbound)","Cawthorne Channel (outbound)",
                    }
                    else _vstor or _vmom or "Chapel"
                )
    ...
    # ── MTSanBarth transload — append to discharging section if active ──────────
    # MTSanBarth behaves like a daughter when transloading: BERTHING_B →
    # HOSE_CONNECT_B → DISCHARGING → CAST_OFF_B.  Pull its status from the
    # timeline and its target mother from the SJ_TRANSLOAD_START log event.
    _sj_tl_st = None
    if "MTSanBarth" in tl_df.columns and not _d1_tl.empty:
        _sj_tl_st = str(_d1_tl.iloc[0]["MTSanBarth"]) if "MTSanBarth" in _d1_tl.columns else None
    if _sj_tl_st and _sj_tl_st not in (None, "IDLE_B", "nan"):
        ...
        if not _sj_log_ev.empty:
            _sj_detail = _sj_log_ev.iloc[0]["Detail"]
            _sj_m = re.search(r"→\s*(\w+):", _sj_detail)
            if _sj_m:
                _sj_mother = _sj_m.group(1)
        if not _sj_disch_ev.empty:
            _sj_cargo = _pcargo(_sj_disch_ev.iloc[0]["Detail"])
        _sj_slabel = {
            "BERTHING_B":   "Berthing (transload)",
            "HOSE_CONNECT_B":"Hose Connect (transload)",
            "DISCHARGING":  "Discharging (transload)",
            "CAST_OFF_B":   "Cast-off (transload)",
        }.get(_sj_tl_st, f"Transloading ({_sj_tl_st})")
        _discharging.append({"vessel": "MTSanBarth", "mother": _sj_mother,
                              "status": _sj_slabel, "cargo": _sj_cargo, "api": 0.0})
...
Generated {_dt.datetime.now().strftime('%Y-%m-%d %H:%M')} | Tanker Operations Simulation v5
    ...
    all_moth = sum(S.get(f"final_{n}",0) for n in ["Bryanston","GreenEagle","MTSanBarth"])
    ...
    _all_moth_vol = sum(S.get(f"final_{n}", 0) for n in ["Bryanston","GreenEagle","MTSanBarth"])
    _blended_moth = (
        sum(S.get(f"final_{n}", 0) * _mapi.get(n, 0.0)
            for n in ["Bryanston","GreenEagle","MTSanBarth"]) / _all_moth_vol
    ...
    _final_mothers = sum(S.get(f"final_{n}", 0) for n in ["Bryanston","GreenEagle","MTSanBarth"])

    # Storage by field
    _stor_finals = {n: S.get(f"final_{n}", 0) for n in ["Chapel","JasmineS","Westmore","Duke","Starturn","PGM"]}
    _capacities  = {"Chapel":270_000,"JasmineS":290_000,"Westmore":270_000,"Duke":90_000,"Starturn":70_000,"PGM":40_000}
...
<div class="summary-card">
  ...
  <ul>
    ...
    # Determine which primary mother MTSanBarth is currently transloading to
    # by reading the most recent SJ_TRANSLOAD_START event from the log
    _sj_active_target = None
    _sj_active_status = None
    if not log_df.empty and "MTSanBarth" in tl_df.columns:
        _sj_log = log_df[log_df["Vessel"] == "MTSanBarth"]
        _sj_start = _sj_log[_sj_log["Event"] == "SJ_TRANSLOAD_START"]
        _sj_done  = _sj_log[_sj_log["Event"].isin(["SJ_TRANSLOAD_COMPLETE","SJ_TRANSLOAD_ABORT"])]
        if not _sj_start.empty:
            _last_start_idx = _sj_start.index[-1]
            _last_done_idx  = _sj_done.index[-1] if not _sj_done.empty else -1
            if _last_start_idx > _last_done_idx:
                # Most recent start has no matching complete — transload in progress
                _sj_active_target = str(_sj_start.iloc[-1].get("Mother", ""))
                # Find current MTSanBarth status from last row of timeline
                _last_sj_status = (
                    tl_df["MTSanBarth"].dropna().iloc[-1]
                    if "MTSanBarth" in tl_df.columns and not tl_df["MTSanBarth"].dropna().empty
                    else None
                )
                _sj_active_status = _last_sj_status
    ...
    for i,(mn,mk) in enumerate([("Bryanston","bryanston"),
        ...
        with mc[i]:
            ...
            if mn == "MTSanBarth":
                _sj_xld = S.get("mtsanbarth_total_transloaded", 0.0)
                kpi("MT SanBarth ⇄",
                    f"{fv:,.0f} bbl",
                    sub=f'<span style="background:#000000;color:#ffffff;padding:2px 8px;border-radius:4px;font-size:10px;font-weight:700">⇄ {_sj_xld:,.0f} bbl transloaded</span>'
                        f'<br><span style="color:#94a3b8;font-size:10px">No export · Transload only</span>'
                        f'{_api_txt}')
            else:
                # Show MTSanBarth active transload indicator if it is currently
                # pumping to this mother — mirrors the daughter discharge indicator
                _sj_badge = ""
                if _sj_active_target == mn and _sj_active_status:
                    _phase_labels = {
                        "BERTHING_B":    "⇄ MT SanBarth berthing",
                        "HOSE_CONNECT_B":"⇄ MT SanBarth hose connecting",
                        "DISCHARGING":   "⇄ MT SanBarth discharging",
                        "CAST_OFF_B":    "⇄ MT SanBarth cast-off",
                    }
                    _ph = _phase_labels.get(_sj_active_status,
                                            f"⇄ MT SanBarth {_sj_active_status}")
                    _sj_badge = (
                        f'<br><span style="background:#000000;color:#fff;'
                        f'padding:2px 8px;border-radius:4px;font-size:10px;'
                        f'font-weight:700">{_ph}</span>'
                    )
                kpi(mn, f"{fv:,.0f} bbl",
                    sub=f'<span style="color:{col_s}">{"▲" if d>=0 else "▼"} '
                        f'{d:+,.0f} bbl vs 08:00</span>{_api_txt}{_sj_badge}')
    ...
    stabs = st.tabs(["Chapel (A)","JasmineS (A)","Westmore (C)","Duke (D)","Starturn (E)","PGM (G)"])
    st_info = [
        ...
        ("PGM","PGM_bbl","PGM_Overflow_Accum_bbl",40_000,"G",sorted(getattr(mod,"PGM_PERMITTED_VESSELS",{"SantaMonica"}))),
    ]
    ...
    extra  = [c for c in ["Chapel_bbl","JasmineS_bbl","Westmore_bbl",
                           ...
                           "Bryanston_api","GreenEagle_api",
                           "MTSanBarth_api"] if c in filt.columns]
    _filt_show = filt[show_c+extra].rename(columns={
        ...
        "GreenEagle_api": "GreenEagle API°", "MTSanBarth_api": "MTSanBarth API°",
    })
    ...
    with d3:
        ...
        for mn in ["Bryanston","GreenEagle","MTSanBarth"]:
