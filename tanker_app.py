...
def run_optimizer(base_params_json: str):
    ...
    def _restore():
        ...
        if hasattr(mod, "SANJULIAN_OPTIM_THRESHOLD_FRAC"):  mod.SANJULIAN_OPTIM_THRESHOLD_FRAC  = _orig_sj_thr
        if hasattr(mod, "SANJULIAN_OPTIM_MIN_SPACE_BBL"):   mod.SANJULIAN_OPTIM_MIN_SPACE_BBL   = _orig_sj_spc
    ...
    try:
        for rank, (dsf, pft, expw, (bstart, bend), (sj_thr, sj_spc)) in enumerate(_grid, 1):
            try:
                ...
                if hasattr(mod, "SANJULIAN_OPTIM_THRESHOLD_FRAC"):  mod.SANJULIAN_OPTIM_THRESHOLD_FRAC  = sj_thr
                if hasattr(mod, "SANJULIAN_OPTIM_MIN_SPACE_BBL"):   mod.SANJULIAN_OPTIM_MIN_SPACE_BBL   = sj_spc
...
def main():
    ...
    with _ctrl_data:
        ...
        with _data_left:
            ...
            sheet_id = st.text_input("Sheet ID", disabled=not use_gs, placeholder="Long ID from sheet URL…")
