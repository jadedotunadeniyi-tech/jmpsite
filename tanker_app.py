...
VESSEL_COLORS = {
    ...
    "SanJulian": "#f39c12",   # vivid amber   — matches SanJulian brand colour
}
STORAGE_COLORS = {
...
MOTHER_COLORS = {
    ...
    "SanJulian" : "#f39c12",  # vivid amber   — matches brand colour used in UI
}
STATUS_LIGHTNESS = {
...
def chart_gantt(tl_df, vessel_names, log_df=None):
    ...
    _CATS = {
        ...
        "Idle"         : ("#475569", "💤 Idle"),
        "Transloading" : ("#f39c12", "⇄ SanJulian Transloading"),
    }
    ...
    if _sj_has_col:
        _sj_col   = "#f39c12"  # amber — matches MOTHER_COLORS["SanJulian"]
    ...
    _all_tick_text    = [
        ...
        ["<span style=\"color:#f39c12;font-weight:700\">⇄ SanJulian</span>"]
        if _sj_has_col else []
    )
...
def render_mother_cards(gs_vols, manual_mother, mod):
    ...
    for i, (mn, mk) in enumerate([
        ...
        if mn == "SanJulian":
            ...
            flag = (
                '<span style="color:#f39c12;font-size:11px">⇄ Transloads to primary mothers</span>'
    ...
    for i,(mn,mk) in enumerate([("Bryanston","bryanston"),
        ...
        with mc[i]:
            ...
            if mn == "SanJulian":
                ...
                kpi("SanJulian ⇄",
                    f"{fv:,.0f} bbl",
                    sub=f'<span style="color:#f39c12">⇄ {_sj_xld:,.0f} bbl transloaded</span>'
                ...
                if _sj_active_target == mn and _sj_active_status:
                    ...
                    _sj_badge = (
                        f'<br><span style="background:#f39c12;color:#fff;'
